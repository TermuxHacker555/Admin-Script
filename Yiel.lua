...
TextBox.Text = "Sub Im Patrick Plz. Please go to our website or discord server to get a currently supported version.\n\ndiscord.io/infiniteyield\n\ninfyield.yolasite.com"
...
loadstring(game:HttpGet((''),true))() end end
...
if pcall(function() loadstring(game:HttpGet((''),true))() end) then
	if workspace.FilteringEnabled == true then
...
Updates:Destroy() loadstring(game:HttpGet((''),true))() end UPDATE.MouseButton1Down:connect(Click) end 
